...
// Stessa lista di MAT_STANDARD_FANTINA (più sotto in questo file) e di
// MAT_STANDARD in viti.js. Tenute distinte per evitare accoppiamenti
// tra logiche separate; un'unificazione è un refactor a parte.
 ...
 * Esportata per riuso anche da calcolaSbavatura in viti.js.
 */
 ...
 * fallback). Algoritmo struct-identico a calcolaSbavatura (in viti.js):
 ...
 *   - variabile soglia: n_smussi (qta scalata per smussi_per_pezzo)
 *   - ordine selezione INVERSO: lotto grande → copiatore, piccolo → ceriotti
 *   - costo orario discriminato internamente sul Ø (regola del vecchio
 *     smussoCosto: dian < 56 → co1, altrimenti co2)
 *
...
export function calcolaSmusso(dian, lungh_pezzo, mat, qta, smussi_per_pezzo, co1, co2, T) {
  ...
  // Selezione macchina: ordine INVERSO rispetto alla sbavatura
  // (lotto grande → copiatore, lotto piccolo → ceriotti)
